...
export class UserEditComponent implements OnInit, OnDestroy {
	...
	initUser() {
		this.createForm();
		if (!this.user.id) {
			this.subheaderService.setTitle('Usuário');
			this.subheaderService.setBreadcrumbs([
				{ title: 'Usuário', page: `user-management` },
				{ title: 'Usuário',  page: `user-management/users` },
				{ title: 'Novo Usuário', page: `user-management/users/add` }
			]);
			return;
		}
		this.subheaderService.setTitle('Usuário');
		this.subheaderService.setBreadcrumbs([
			{ title: 'Usuário', page: `user-management` },
			{ title: 'Usuário',  page: `user-management/users` },
			{ title: 'Editar Usuário', page: `user-management/users/edit`, queryParams: { id: this.user.id } }
		]);
	}
  ...
  this.userForm.updateValueAndValidity();
	...
	updateUser(_user: User, withBack: boolean = false) {
		...
		const message = `Atualização realizado com sucesso.`;
	 ...
	 */
	getComponentTitle() {
		let result = 'Novo usuário';
		if (!this.user || !this.user.id) {
			return result;
		}

		result = `Editar usuário - ${this.user.fullname}`;
		return result;
	}
