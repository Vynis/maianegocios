...
export class UsersListComponent implements OnInit, OnDestroy {
	...
	displayedColumns = [ 'id',  'fullname', 'username', 'email', '_roles', 'actions'];
	...
	ngOnInit() {
		...
		**/
		...
		this.subheaderService.setTitle('Usuários');
	...
	deleteUser(_item: User) {
		const _title = 'Deletar Usuário';
		const _description = 'Tem certeza que deseja excluir o usuário?';
		const _waitDesciption = 'Deletando usuário...';
		const _deleteMessage = `Usuário deletado.`;
