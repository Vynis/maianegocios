...
export class LayoutConfig {
	public defaults: LayoutConfigModel = {
		...
		self: {
			...
			logo: {
				dark: './assets/media/logos/logo_maia_dash.png',
				light: './assets/media/logos/logo_maia_dash.png',
				brand: './assets/media/logos/logo_maia_dash.png',
				green: './assets/media/logos/logo_maia_dash.png',
			},
		},
		...
		loader: {
			enabled: true,
			type: 'spinner-logo',
			logo: './assets/media/logos/logo-load-esollar.png',
			message: 'Carregando...',
		},
