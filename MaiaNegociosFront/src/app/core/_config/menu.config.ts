			...
			items: [
				...
				},
				{
					...
					submenu: [
						{
							title: 'Pessoa Física',
							page: '/pessoas/lista-pessoa-fisica',
							bullet: 'dot',
							permission : 'acessoPessoaFisica'
						},
						{
							title: 'Pessoa Jurídica',
							page: '/pessoas/lista-pessoa-juridica',
							bullet: 'dot',
							permission : 'acessoPessoaJuridica'
						}
					]
				},
				{
					...
					submenu: [
						{
							title: 'Usuários',
							page: '/user-management/users',
							permission: 'acessoConfigUsuario'
						},
						{
							title: 'Perfis do Usuário',
							page: '/user-management/roles',
							permission: 'acessoPerfil'
						},
						{
							title: 'Módulo Fv',
							page: '/placasfv/lista',
							permission: 'acessoPlacasFv'
						},
						{
							title: 'Faixa Valor Kwp',
							page: '/faixavalorkwp/lista',
							permission: 'acessoFaixaValorKwp'
						},
						{
							title: 'Parametros do Sistema',
							page: '/parametros/cadastro',
							permission: 'acessoParametrosSistema'
						},
						{
							title: 'Marcas',
							page: '/marcas/lista',
							permission: 'acessoMarcas'
						},
						{
							title: 'Logomarcas',
							page: '/logomarcas/lista',
							permission: 'acessoLogoMarcas'
						}
					]
				},
			]
